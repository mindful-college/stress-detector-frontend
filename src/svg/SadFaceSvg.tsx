...
const SadComponentSvg = ({
  width,
  height,
  strokeWidth,
  color = '#4B4B4B',
}: SadComponentSvgProps) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 122 122" fill="none">
      ...
      />
      <Path
        d="M33.3076 88.6923C37.4408 75.51 53.1468 67.4542 68.853 71.1159C77.946 73.313 85.3857 79.9041 88.6922 88.6923"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export default SadComponentSvg;
